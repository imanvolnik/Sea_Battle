...
menu_x = 250
ships = s_x // 2  # number of ships
ship_len1 = s_x // 5  # len of 1st type ship
ship_len2 = s_x // 3  # len of 2nd type ship
ship_len3 = s_x // 2  # len of 3rd type ship
...
def generate_enemy_ships():
    global enemy_ships
    ships_list = []
    # generate list of random len of ship
                ...
                if primerno_x + len <= s_x:
                    for j in range(0, len):
                        try:
                            ...
                            if check_near_ships == 0:  # count in case if nothing
                                enemy_ships[primerno_y][primerno_x + j] = i + 1  # count number of ship
                        except Exception:
                            pass
                ...
                if primerno_y + len <= s_y:
                    for j in range(0, len):
                        try:
                            ...
                            # print(check_near_ships)
                            if check_near_ships == 0:  # count in case if nothing
                                enemy_ships[primerno_y + j][primerno_x] = i + 1  # count number of ship
                        except Exception:
                            pass
