...
# points -list where we clicked by mouse
...
b0 = Button(tk, text="Show ships ", command=button_show_enemy)
b0.place(x=size_canvas_x + 20, y=30)

b1 = Button(tk, text="Restart!", command=button_begin_again)
...
def add_to_all(event):
    global points
    _type = 0  # left button mouse
    if event.num == 3:
        _type = 1  # right button mouse
    # print(_type)
...
canvas.bind_all("<Button-1>", add_to_all)  # left button mouse
canvas.bind_all("<Button-3>", add_to_all)  # right button mouse
